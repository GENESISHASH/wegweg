...
(function() {
  var decd, e, easy_crypto, encd, iced, log, r, root, weg, wegweg, _, __iced_deferrals, __iced_k, __iced_k_noop,
    __slice = [].slice,
  ...
  module.exports = wegweg = function(opt) {
    ...
    if ((opt.globals != null) && opt.globals) {
      if (root.log == null) {
        root.log = function() {
          var x;
    ...
    if ((opt.shelljs != null) && opt.shelljs) {
    ...
    _.enc = function(x, salt) {
      ...
      res = ec.encrypt(JSON.stringify(x), salt || '2reh9zmtlsfy5gbi');
      return res;
    };
    _.dec = function(x, salt) {
      var ec, res;
      ec = easy_crypto.getInstance();
      res = JSON.parse(ec.decrypt(x, salt || '2reh9zmtlsfy5gbi'));
      return res;
    };
    ...
    _.app = (function(opt) {
      var app, base_dir, body_parser, dir, express, val, _i, _len, _ref, _ref1;
      if (opt == null) {
        opt = {};
      }
      express = require('express');
      app = (_ref = (_ref1 = opt.app) != null ? _ref1 : opt.express) != null ? _ref : express();
  ...
  if (process.env.TAKY_DEV) {
    ...
    log(/cmap/, weg.cmap([1, 2, 3, 4, 5], function(x) {
      if (x === 1 || x === 2 || x === 3) {
        return null;
      }
      return x;
    ...
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          filename: "/home/taky/www/wegweg/src/module.iced"
        });
      ...
      return function() {
        ...
        log(/md5/, weg.md5('ayy'));
        return __iced_k(log(/sha256/, weg.sha256('ayy')));
      };
    })(this));
  } else {
    __iced_k();
